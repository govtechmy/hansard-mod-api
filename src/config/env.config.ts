...
const EnvSchema = z.object({
  ...
  AWS_ACCESS_KEY_ID: z.string().optional().nullable(), // Optional for IAM role environments
  AWS_SECRET_ACCESS_KEY: z.string().optional().nullable(), // Optional for IAM role environments
})
